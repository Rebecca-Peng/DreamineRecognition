...
public class Cave_ImproEHD : MonoBehaviour {
	...
	string[] srcName = new string[NUM]{"Compass","Compass","Bottle"};
...
//	public Transform cu;
	...
	void Update () {
		if(getNewImg){
			if (Cave_CaptureEHD.getImage) {
				dstTexture = Cave_CaptureEHD.dstTexture;
